...
public class UsersClass {
    ...
    public static void register(){
        ...
        while(true) {
            ...
            if (input.equals("")) System.out.println("ERROR! Please provide a valid name: ");
            else {
                userName = input;
                break;
            }
        ...
        while(true) {
            ...
            Scanner scanner = new Scanner(System.in);
            String input = scanner.nextLine();
            if (input.equals("")) System.out.println("ERROR! a password is mandatory: ");
            else {
                password = input;
                break;
            }
        ...
        while(true) {
            ...
            Scanner scanner = new Scanner(System.in);
            String input = scanner.nextLine();
            if (input.equals("")) System.out.println("ERROR! Please provide a valid email: ");
            else {
                email = input;
                break;
            }
        ...
        while(true) {
            ...
            Scanner scanner = new Scanner(System.in);
            String input = scanner.nextLine();
            if (input.equals("")) System.out.println("ERROR! Please enter your first name: ");
            else {
                firstName = input;
                break;
            }
        ...
        while(true) {
            ...
            Scanner scanner = new Scanner(System.in);
            String input = scanner.nextLine();
            if (input.equals("")) System.out.println("ERROR! This field is mandatory: ");
            else {
                middleName = input;
                break;
            }
        ...
        while(true) {
            ...
            Scanner scanner = new Scanner(System.in);
            String input = scanner.nextLine();
            if (input.equals("")) System.out.println("ERROR! Please provide a valid last name: ");
            else {
                lastName = input;
                break;
            }
